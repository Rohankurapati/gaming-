...
const Strings = {
  ...
  'unableToDisplayBoards': {
    ...
    en: 'Unable to display Community',
    jp: 'ボードを表示できません'
  },
  'board': {
    ru: 'Доска',
  ...
  'manageBoards': {
    ...
    en: 'Manage Games community',
    jp: 'ボードを管理する'
  },
  'createNewBoard': {
    ru: 'Создать новую доску',
    en: 'Create new Game community',
    jp: '新しいボードを作成する'
  },
  'enterShortName': {
